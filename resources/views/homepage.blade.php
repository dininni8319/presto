        ...
        <div class="container">
          ...
          <div class="row w-100 p-5">
            <div class="col-12 text-center text-wrap mt-3 fs-4 fw-bold fst-italic text-dark text-homepage-custom">
                <p class="header-blog-text">{{__('ui.header')}}</p>
                
            </div>
          </div>

          <div class="row">
            <h1 class=" my-4 text-center text-shadow-custom">{{ __('ui.latestListing')}}</h1>
                @foreach ($announcements as $announcement)
                    <div class="col-12 col-md-4 ">
                        <div class="card shadow my-3" style="width: 21rem;">
                          ...
                          <div class="card-body">
                            <h5 class="h5">{{Str::limit($announcement->title, 20)}}</h5>
                            <p class="small">{{Str::limit($announcement->description, 30)}}</p>
