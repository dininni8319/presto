<nav class="navbar navbarcustom navbar-expand-lg navbar-dark ">
    <div class="container-fluid">
      ...
      <a  class="navbar-brand" href="{{route('homepage')}}"><img class="img-fluid logo" src="/img/sfondopresto4.png" alt=""></a>
        ...
        <ul class="navbar-nav ms-auto">
          ...
          @endif
            ...
            <li class="nav-item"><a class="nav-link text-capitalize"  href="{{route('logout')}}" onclick="event.preventDefault();
              document.getElementById('form-logout').submit();">{{__('ui.logout')}}</a>
            </li>
